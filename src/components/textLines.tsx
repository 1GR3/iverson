...
const TextLines: React.FC = () => {
    ...
    const textAnimations = [
        ...
        { text: "Millions of its holders have gone<br class='d-block d-md-none' /> unheard. <br class='d-none d-md-block' />We’re here to change that.", fadeIn: 1350, fadeOut: 2450 },
