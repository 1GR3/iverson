...
const SignUpModal: React.FC = () => {
    ...
    // Animation for unmasking the SVG
    const [animateMask, setAnimateMask] = useState(false);
    const svgSpring = useSpring({
        from: { r: 0 }, // Start from 0 to reveal the graphic
        to: { r: animateMask ? 80 : 0 }, // Expand to reveal the entire graphic
        reset: true, // Reset the animation when component remounts
        config: { duration: 1200 }, // Adjust duration as needed
    });

    useEffect(() => {
        if (isSubmitted) {
            setAnimateMask(true); // Ensure the animation runs when submitted
        }
    }, [isSubmitted]);
                                ...
                                <form onSubmit={handleSubmit} noValidate>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        {errors.firstName && <div className="invalid-feedback"><AlertIcon />
                                ...
                                <svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        <mask id="mask">
                                            ...
                                            <animated.circle cx="80" cy="80" r={svgSpring.r} fill="white" />
                                        </mask>
                                    </defs>
                                    <g mask="url(#mask)">
